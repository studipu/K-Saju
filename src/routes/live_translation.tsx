      ...
      <Grid>
        ...
        <Panel>
          ...
          <StatusIndicator $isRecording={running}>
            ...
            {running
              ? `🔴 ${recorder.currentSpeaker === "customer" ? t("customerVoice").replace("🎤 ", "") : t("businessVoice").replace("🎯 ", "")} ${t("recordingMessage").replace("{0}", "").replace("({1}초 남음)", `(${Math.ceil(10 - recorder.recordingTime)}초 남음)`)}`
              : t("waitingMessage")}
          </StatusIndicator>
